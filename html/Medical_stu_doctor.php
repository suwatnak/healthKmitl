...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>บันทึกการรักษานักศึกษา</title>
   ...
   <link rel="shortcut icon" href="../assets/images/A_A.ico" />
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="tabbable">
                                    ...
                                    <div class="tab-content">
                                        <div id="home" class="tab-pane fade in active">
                                            ...
                                            <form class="form-horizontal" role="form">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-1 control-label no-padding-right" for="codestudent">รหัสนักศึกษา:</label>
                                                    <div class="col-sm-2">
                                                        <span class="block input-icon input-icon-right">
                                                            <input class="form-control" type="text" id="codestudent" placeholder="รหัสนักศึกษา" maxlength ="8" oninput="chackcodestudent()"  />  
                                                            <i class="ace-icon fa fa-info-circle"></i>
                                                        </span>
                                                    </div><div class="col-sm-2" id="showresultcodestudent"></div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="radio" >
                                                        <label>
                                                            <input name="gender" type="radio" value="M" class="ace input-small" disabled="disabled"/>
                                                            <span class="lbl"> ชาย</span>
                                                        </label>
                                                        <label>
                                                            <input name="gender" type="radio"value="F"  class="ace input-small" disabled="disabled" />
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-1 control-label no-padding-right" for="namestudent">ชื่อ :</label>
                                                    <div class="col-sm-2">
                                                        <input type="text" id="namestudent" placeholder="ชื่อ" disabled="disabled" />
                                                    </div>
                                                    <label class="col-xs-1 control-label no-padding-right" for="lastnamestudent">นามสกุล :</label>
                                                    <div class="col-sm-2">
                                                        <input type="text" id="lastnamestudent" placeholder="นามสกุล" disabled="disabled"/>
                                                    </div>
                                                    <label class="col-xs-1 control-label no-padding-right" for="facultystudent">คณะ :</label>
                                                    <div class="col-sm-3">
                                                        <!-- #section:plugins/input.chosen -->
                                                        <div>
                                                            <select class="form-control" name="facultystudent" id="facultystudent"  disabled="disabled">
                                                                <option value="0"></option>
                                                                <?php
                                                                require("db_connect.php");
                                                                $strSQL = "SELECT FACID,TNAME FROM A_FACULTY";
                                        ...
                                        <div id="addstudent" class="modal" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h4 class="blue bigger">ไม่พบข้อมูลนักศึกษา => กรุณากรอกข้อมูลนักศึกษา</h4>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="">
                                                                <form class="form-horizontal" role="form" name="formaddstudent">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">รหัสนักศึกษา:</label>
                                                                        <div class="col-sm-4">
                                                                            <span class="block input-icon input-icon-right">
                                                                                <input class="form-control"  type="text" name="addcodestudent" id="addcodestudent" placeholder="รหัสนักศึกษา 8 หลัก" disabled="disabled" />   
                                                                                <i class="ace-icon fa fa-info-circle"></i>
                                                                            </span>
                                                                        </div>
                                                                    </div> 
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            <input type="text" name="addnamestudent" id="addnamestudent" placeholder="ชื่อ"  />
                                                                        </div>
                                                                        <label class="col-sm-1 control-label no-padding-right" for="form-field-1-2">นามสกุล:</label>
                                                                        <div class="col-sm-2">
                                                                            <input type="text" name="addlastnamestudent" id="addlastnamestudent" placeholder="นามสกุล"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <div class="col-sm-1"></div>
                                                                        <label class="col-sm-1 control-label no-padding-right" for="addfacultystudent">คณะ :</label>
                                                                        <div class="col-sm-5">
                                                                            <!-- #section:plugins/input.chosen -->
                                                                            <div>
                                                                                <select class="form-control"  id="addfacultystudent" data-placeholder="กรุณาเลือกคณะ">
                                                                                    <option value="0">  </option>
                                                                                    <?php
                                                                                    require("db_connect.php");
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button  class="btn btn-sm btn-primary" id="addstudent" onclick="addstudent()" >
                                ...
                                <!-- PAGE CONTENT ENDS -->
                            </div><!-- /.col --><button type="button" id="addstudentt"  role="button"  href="#addstudent"  data-toggle="modal"></button>
                        </div><!-- /.row -->
                    </div><!-- /.page-content -->
                </div>
            </div><!-- /.main-content -->
    ...
    <![endif]-->
        ...
        <script src="../assets/js/Medical_stu_doctor_js.js"></script>
