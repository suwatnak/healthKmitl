                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <!--                                 PAGE CONTENT BEGINS -->
                                <h3 class="header smaller lighter blue">รายงานสรุป</h3>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <div class="checkbox col-sm-2">
                                                <label>
                                                    <input name="showdetail" id='showdetail' value="1" class="ace ace-checkbox-2" type="checkbox"/>
                                                    <span class="lbl">แสดงข้อมูลรายละเอียด</span>
                                                </label>
                                            </div>
                                            <label class="col-sm-1 control-label no-padding-right" for="form-field-1">เรียงตาม: </label>
                                            <div class="col-sm-2" >
                                                <select class=" form-control"  id="sort" data-placeholder="กรุณาเลือกชื่อยา" disabled='disabled'>
                                                    <option value="PATIENTID">รหัสผู้ป่วย</option>
                                                    <option value="TYPE">ประเภท</option>
                                                    <option value="TNAME">ชื่อ</option>
                                                    <option value="LNAME">นามสกุล</option>
                                                    <option value="FACULTY">หน่วยงาน</option>
                                                    <option value="DIS">โรค</option>
                                                    <option value="DATEE">วัน</option>
...
<![endif]-->
        ...
        <script type="text/javascript">
            ...
            $("#showdetail").change(function () {
                ...
                if ($("#showdetail").is(':checked'))
                {
                    $('#sort').removeAttr('disabled');
                    output = $("#showdetail").val();
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (x == 0)
                            {
                                ...
                                location.href = 'reportsummaryday_csv.php?start=' + start + '&end=' + end + '&sort=' + sort + '&output=' + output;
                            }
                        }
                    }); // end ajax call
                }
